...
__all__ = ['DireccionForm']


class DireccionForm(forms.ModelForm):
    """
        Direccion form class.
    """
    class Meta(object):
        """
            Form options for DireccionForm.
        """
        model = Direccion
        fields = ('tipovia', 'nombre_via', 'numero', 'planta', 'puerta',
                  'localidad', 'provincia', 'codigo_postal', 'nif',
